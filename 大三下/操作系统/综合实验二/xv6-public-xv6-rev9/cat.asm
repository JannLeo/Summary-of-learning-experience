...
000003f2 <sh_var_read>:
SYSCALL(sh_var_read)
 3f2:	b8 16 00 00 00       	mov    $0x16,%eax
 3f7:	cd 40                	int    $0x40
 3f9:	c3                   	ret    

000003fa <sh_var_write>:
 ...
 469:	85 d2                	test   %edx,%edx
{
 ...
 497:	f7 f1                	div    %ecx
 499:	0f b6 92 88 08 00 00 	movzbl 0x888(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 540:	e8 1d fe ff ff       	call   362 <write>
 ...
 5a1:	e8 bc fd ff ff       	call   362 <write>
 ...
 5b8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 5ba:	e8 a3 fd ff ff       	call   362 <write>
  for(i = 0; fmt[i]; i++){
 ...
 653:	57                   	push   %edi
 654:	53                   	push   %ebx
 655:	e8 08 fd ff ff       	call   362 <write>
        while(*s != 0){
 ...
 6a7:	e8 b6 fc ff ff       	call   362 <write>
        ap++;
 ...
 6b4:	e9 8f fe ff ff       	jmp    548 <printf+0x48>
          s = "(null)";
 6b9:	bb 7e 08 00 00       	mov    $0x87e,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7be:	56                   	push   %esi
 7bf:	e8 06 fc ff ff       	call   3ca <sbrk>
  if(p == (char*)-1)
