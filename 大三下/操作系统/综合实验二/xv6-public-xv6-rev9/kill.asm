...
free(void *ap)
{
 ...
 641:	a1 90 0a 00 00       	mov    0xa90,%eax
{
 ...
 67d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 67f:	a3 90 0a 00 00       	mov    %eax,0xa90
}
 684:	5b                   	pop    %ebx
 685:	5e                   	pop    %esi
 686:	5f                   	pop    %edi
 ...
 696:	72 ce                	jb     666 <free+0x26>
{
 ...
 6b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ba:	a3 90 0a 00 00       	mov    %eax,0xa90
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 15 90 0a 00 00    	mov    0xa90,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 47                	jae    768 <malloc+0x98>
    ...
    if(p == freep)
 721:	39 05 90 0a 00 00    	cmp    %eax,0xa90
 ...
 746:	e8 f5 fe ff ff       	call   640 <free>
  return freep;
 74b:	8b 15 90 0a 00 00    	mov    0xa90,%edx
 ...
 774:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 777:	89 15 90 0a 00 00    	mov    %edx,0xa90
}
 ...
 797:	0a 00 00 
 79a:	c7 05 94 0a 00 00 94 	movl   $0xa94,0xa94
 7a1:	0a 00 00 
    base.s.size = 0;
 7a4:	b8 94 0a 00 00       	mov    $0xa94,%eax
 7a9:	c7 05 98 0a 00 00 00 	movl   $0x0,0xa98
 7b0:	00 00 00 
