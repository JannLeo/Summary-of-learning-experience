...
_sem-test1:     file format elf32-i386
...
int main(int argc, char *argv[])
{
   ...
   f:	51                   	push   %ecx
    int pid = fork();//产生子进程
  10:	bb a0 86 01 00       	mov    $0x186a0,%ebx
{
  15:	83 ec 0c             	sub    $0xc,%esp
    int pid = fork();//产生子进程
  18:	e8 8d 02 00 00       	call   2aa <fork>
  1d:	89 c6                	mov    %eax,%esi
  1f:	90                   	nop
    int i,n;
    for(i=0; i< 100000;i++){//循环10w次
        n=sh_var_read();
  20:	e8 3d 03 00 00       	call   362 <sh_var_read>
        sh_var_write(n+1);//写信号量，每次循环信号量++
  25:	83 ec 0c             	sub    $0xc,%esp
  28:	83 c0 01             	add    $0x1,%eax
  2b:	50                   	push   %eax
  2c:	e8 39 03 00 00       	call   36a <sh_var_write>
    for(i=0; i< 100000;i++){//循环10w次
  ...
  37:	75 e7                	jne    20 <main+0x20>
    ...
    printf(1,"sum = %d\n",sh_var_read());//输出信号量的值
  39:	e8 24 03 00 00       	call   362 <sh_var_read>
  3e:	83 ec 04             	sub    $0x4,%esp
  41:	50                   	push   %eax
  42:	68 c8 07 00 00       	push   $0x7c8
  47:	6a 01                	push   $0x1
  49:	e8 22 04 00 00       	call   470 <printf>
    if(pid>0) {
  4e:	83 c4 10             	add    $0x10,%esp
  51:	85 f6                	test   %esi,%esi
  53:	7e 05                	jle    5a <main+0x5a>
        wait();//等待子进程完成，防止产生僵尸进程
  55:	e8 60 02 00 00       	call   2ba <wait>
    }
    exit();
...
free(void *ap)
{
 ...
 641:	a1 88 0a 00 00       	mov    0xa88,%eax
{
 ...
 67d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 67f:	a3 88 0a 00 00       	mov    %eax,0xa88
}
 684:	5b                   	pop    %ebx
 685:	5e                   	pop    %esi
 686:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 15 88 0a 00 00    	mov    0xa88,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 47                	jae    768 <malloc+0x98>
    ...
    if(p == freep)
 721:	39 05 88 0a 00 00    	cmp    %eax,0xa88
 ...
 746:	e8 f5 fe ff ff       	call   640 <free>
  return freep;
 74b:	8b 15 88 0a 00 00    	mov    0xa88,%edx
 ...
 797:	0a 00 00 
 79a:	c7 05 8c 0a 00 00 8c 	movl   $0xa8c,0xa8c
 7a1:	0a 00 00 
    base.s.size = 0;
 7a4:	b8 8c 0a 00 00       	mov    $0xa8c,%eax
 7a9:	c7 05 90 0a 00 00 00 	movl   $0x0,0xa90
 7b0:	00 00 00 
