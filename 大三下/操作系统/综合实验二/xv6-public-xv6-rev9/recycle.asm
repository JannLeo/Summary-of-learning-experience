...
_recycle:     file format elf32-i386
...
int main(int argc,char *argv[]){
   ...
   f:	51                   	push   %ecx
    ...
    int a[8];
    int pid=fork();
  10:	be 00 90 01 00       	mov    $0x19000,%esi
int main(int argc,char *argv[]){
  ...
  2a:	83 c2 01             	add    $0x1,%edx
                   a[k%8]=pid*k; 
  2d:	83 e3 07             	and    $0x7,%ebx
  30:	89 4c 9d c8          	mov    %ecx,-0x38(%ebp,%ebx,4)
  34:	01 c1                	add    %eax,%ecx
            for(int k=0;k<1024*100;k++){
  36:	81 fa 00 90 01 00    	cmp    $0x19000,%edx
  3c:	75 ea                	jne    28 <main+0x28>
        for(int j=0;j<1024*100;j++){
  3e:	83 ee 01             	sub    $0x1,%esi
  41:	75 dd                	jne    20 <main+0x20>
  43:	be 00 90 01 00       	mov    $0x19000,%esi
  48:	90                   	nop
  ...
  5a:	83 c2 01             	add    $0x1,%edx
                   a[k%8]=pid*k; 
  5d:	83 e3 07             	and    $0x7,%ebx
  60:	89 4c 9d c8          	mov    %ecx,-0x38(%ebp,%ebx,4)
  64:	01 c1                	add    %eax,%ecx
            for(int k=0;k<1024*100;k++){
  66:	81 fa 00 90 01 00    	cmp    $0x19000,%edx
  6c:	75 ea                	jne    58 <main+0x58>
        for(int j=0;j<1024*100;j++){
  6e:	83 ee 01             	sub    $0x1,%esi
 ...
 409:	85 d2                	test   %edx,%edx
{
 ...
 437:	f7 f1                	div    %ecx
 439:	0f b6 92 04 08 00 00 	movzbl 0x804(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 654:	e9 8f fe ff ff       	jmp    4e8 <printf+0x48>
          s = "(null)";
 659:	bb fb 07 00 00       	mov    $0x7fb,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 671:	a1 b0 0a 00 00       	mov    0xab0,%eax
{
 ...
 6ad:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6af:	a3 b0 0a 00 00       	mov    %eax,0xab0
}
 6b4:	5b                   	pop    %ebx
 6b5:	5e                   	pop    %esi
 6b6:	5f                   	pop    %edi
 ...
 6c6:	72 ce                	jb     696 <free+0x26>
{
 ...
 6e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ea:	a3 b0 0a 00 00       	mov    %eax,0xab0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 15 b0 0a 00 00    	mov    0xab0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 47                	jae    798 <malloc+0x98>
    ...
    if(p == freep)
 751:	39 05 b0 0a 00 00    	cmp    %eax,0xab0
 ...
 776:	e8 f5 fe ff ff       	call   670 <free>
  return freep;
 77b:	8b 15 b0 0a 00 00    	mov    0xab0,%edx
 ...
 7a4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7a7:	89 15 b0 0a 00 00    	mov    %edx,0xab0
}
 ...
 7b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 b0 0a 00 00 b4 	movl   $0xab4,0xab0
 7c7:	0a 00 00 
 7ca:	c7 05 b4 0a 00 00 b4 	movl   $0xab4,0xab4
 7d1:	0a 00 00 
    base.s.size = 0;
 7d4:	b8 b4 0a 00 00       	mov    $0xab4,%eax
 7d9:	c7 05 b8 0a 00 00 00 	movl   $0x0,0xab8
 7e0:	00 00 00 
