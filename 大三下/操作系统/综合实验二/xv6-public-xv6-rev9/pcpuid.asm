...
_pcpuid:     file format elf32-i386
...
printf(1,"My CPU id is :%d\n",getcpuid());
  11:	e8 0c 03 00 00       	call   322 <getcpuid>
...
printf(int fd, char *fmt, ...)
{
 ...
 480:	e8 1d fe ff ff       	call   2a2 <write>
 ...
 4e1:	e8 bc fd ff ff       	call   2a2 <write>
 ...
 4f8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4fa:	e8 a3 fd ff ff       	call   2a2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 593:	57                   	push   %edi
 594:	53                   	push   %ebx
 595:	e8 08 fd ff ff       	call   2a2 <write>
        while(*s != 0){
 ...
 5e7:	e8 b6 fc ff ff       	call   2a2 <write>
        ap++;
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb aa 07 00 00       	mov    $0x7aa,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6fe:	56                   	push   %esi
 6ff:	e8 06 fc ff ff       	call   30a <sbrk>
  if(p == (char*)-1)
