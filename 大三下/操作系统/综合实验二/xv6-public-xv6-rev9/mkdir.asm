 ...
 661:	a1 d4 0a 00 00       	mov    0xad4,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 d4 0a 00 00       	mov    %eax,0xad4
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 73f:	73 47                	jae    788 <malloc+0x98>
    ...
    if(p == freep)
 741:	39 05 d4 0a 00 00    	cmp    %eax,0xad4
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
  return freep;
 76b:	8b 15 d4 0a 00 00    	mov    0xad4,%edx
 ...
 7b7:	0a 00 00 
 7ba:	c7 05 d8 0a 00 00 d8 	movl   $0xad8,0xad8
 7c1:	0a 00 00 
    base.s.size = 0;
 7c4:	b8 d8 0a 00 00       	mov    $0xad8,%eax
 7c9:	c7 05 dc 0a 00 00 00 	movl   $0x0,0xadc
 7d0:	00 00 00 
