...
printf(int fd, char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb b2 07 00 00       	mov    $0x7b2,%ebx
        while(*s != 0){
 ...
 621:	a1 68 0a 00 00       	mov    0xa68,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 68 0a 00 00       	mov    %eax,0xa68
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
    ...
    if(p == freep)
 701:	39 05 68 0a 00 00    	cmp    %eax,0xa68
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 68 0a 00 00    	mov    0xa68,%edx
 ...
 777:	0a 00 00 
 77a:	c7 05 6c 0a 00 00 6c 	movl   $0xa6c,0xa6c
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 6c 0a 00 00       	mov    $0xa6c,%eax
 789:	c7 05 70 0a 00 00 00 	movl   $0x0,0xa70
 790:	00 00 00 
