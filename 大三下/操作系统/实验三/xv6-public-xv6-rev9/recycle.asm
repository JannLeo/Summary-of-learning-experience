...
printf(int fd, char *fmt, ...)
{
 ...
 634:	e9 8f fe ff ff       	jmp    4c8 <printf+0x48>
          s = "(null)";
 639:	bb db 07 00 00       	mov    $0x7db,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 651:	a1 90 0a 00 00       	mov    0xa90,%eax
{
 ...
 68d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 68f:	a3 90 0a 00 00       	mov    %eax,0xa90
}
 694:	5b                   	pop    %ebx
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 90 0a 00 00    	mov    0xa90,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 47                	jae    778 <malloc+0x98>
    ...
    if(p == freep)
 731:	39 05 90 0a 00 00    	cmp    %eax,0xa90
 ...
 756:	e8 f5 fe ff ff       	call   650 <free>
  return freep;
 75b:	8b 15 90 0a 00 00    	mov    0xa90,%edx
 ...
 784:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 787:	89 15 90 0a 00 00    	mov    %edx,0xa90
}
 ...
 799:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 90 0a 00 00 94 	movl   $0xa94,0xa90
 7a7:	0a 00 00 
 7aa:	c7 05 94 0a 00 00 94 	movl   $0xa94,0xa94
 7b1:	0a 00 00 
    base.s.size = 0;
 7b4:	b8 94 0a 00 00       	mov    $0xa94,%eax
 7b9:	c7 05 98 0a 00 00 00 	movl   $0x0,0xa98
 7c0:	00 00 00 
