...
#define USER_NAME "ZHU ZHU"

// Firmware version
#define FW_VERSION	"  2023/4/10" // maybe use some __DATE__ __TIME__ stuff?
...
#define COMPILE_GAME3      1 // 游戏Flappy thing (not finished) bug  
...
//#define RTC_SRC   ///在无外部时钟时间 请注销这里          BUG ，修改millis.c里面的z中断计时软件
