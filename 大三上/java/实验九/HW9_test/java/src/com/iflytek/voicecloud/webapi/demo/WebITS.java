...
public class WebITS {	
	...
	// 应用ID（到控制台获取）
	private static final String APPID = "6cc86b46";
	// 接口APISercet（到控制台机器翻译服务页面获取）
	private static final String API_SECRET = "YzAwMGY2ZjkwODgxNGJhY2U4NDc5Yjc4";
	// 接口APIKey（到控制台机器翻译服务页面获取）
	private static final String API_KEY = "2638a48ac0911e81e5336bf5739f119c";
	...
	public static String main(String a) throws Exception {
		//更新要翻译的字符串
		TEXT=a;
...
//			Pattern p;
//			Matcher m;
//			p=Pattern.compile("\"dst\":\"(.+)\",\"src\"");
//			m=p.matcher(resultStr);
//			while(m.find())
//			{
//				String mm=m.group();
//				mm=mm.substring(7,mm.length()-7);
